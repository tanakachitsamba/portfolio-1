import { o as De, t as ye } from '../chunks/index.6dba6488.js';
import {
	S as He,
	a as Je,
	I as V,
	...
	P as qe,
	h as We
} from '../chunks/singletons.77721be9.js';
function Xe(t, o) {
	return t === '/' || o === 'ignore'
		? t
		: o === 'never'
...
function Rt(t, o) {
	...
	function Oe(e) {
		...
		n && n.remove(),
			(F = e.props.page),
			(q = new t.root({ target: o, props: { ...e.props, stores: M, components: l }, hydrate: !0 })),
			Ae(j);
		const r = {
			from: null,
			to: {
	...
	async function Y({ url: e, params: n, branch: r, status: a, error: s, route: c, form: g }) {
		...
		return (
			(!p.url || e.href !== p.url.href || p.error !== s || (g !== void 0 && g !== F.form) || R) &&
				(v.props.page = {
					error: s,
					params: n,
		...
		for (let E = 0; E < v.length; E += 1)
			if (v[E])
				try {
					...
					if (L instanceof Me) return { type: 'redirect', location: L.location };
					let I = 500,
						T;
		...
		_start_router: () => {
			...
			(history.scrollRestoration = 'manual'),
				...
				addEventListener('hashchange', () => {
					z && ((z = !1), history.replaceState({ ...history.state, [V]: ++j }, '', location.href));
				});
